...
let rootUrl = URL(string: "https://luxdriver-motorista.luxtransfers.pt/luxdriver-motorista.html")!

// allowed origin is for what we are sticking to pwa domain
// This should also appear in Info.plist
let allowedOrigins: [String] = ["luxdriver-motorista.luxtransfers.pt"]
